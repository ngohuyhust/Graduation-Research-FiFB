    ...
    <>
      ...
      <form className="panel space-y-5" onSubmit={form.handleSubmit(onSubmit)}>
        <div className="flex items-center gap-4">
          <div className="grid h-16 w-16 place-items-center rounded-full bg-mint/10 text-mint">
            <UserRound size={30} />
          </div>
          <div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="md:col-span-2">
            <FormField label="Bio">
              <textarea className="input min-h-32" {...form.register("bio")} />
            </FormField>
          </div>
          <FormField label="Specialization">
            <input className="input" {...form.register("specialization")} />
          </FormField>
          <FormField label="Years of experience">
            <input className="input" min="0" type="number" {...form.register("yearsOfExperience")} />
          </FormField>
        </div>
