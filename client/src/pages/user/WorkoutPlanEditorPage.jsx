    ...
    <>
      ...
      <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
        <section className="panel grid gap-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2"><FormField label="Description"><textarea className="input min-h-24" {...form.register("description")} /></FormField></div>
        </section>
        ...
        <button className="btn-primary" disabled={form.formState.isSubmitting} type="submit">Save plan</button>
      </form>
    </>
  );
}
