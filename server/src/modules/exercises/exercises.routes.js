...
router.post("/", authenticate, requireActiveUser, requireVerifiedEmail, requireRoles("admin", "trainer"), validate(validation.exercisePayloadSchema), asyncHandler(controller.create));
